/*
 * AES: 16 block no matter what
 * key size 128 bits (16 bytes): 10 rounds of AES
 * key size 192 bits (24 bytes): 12 rounds of AES
 * key size 256 bits (32 bytes): 14 rounds of AES
 * each round uses 16 bytes of keying material
 */
